...
contract DADAMOON is Context, IERC20, Ownable, MinterRole {
    ...
    address mainWallet = 0x5D2f92505bcbF6c3FD8B9C56F8f9541cdC8e7b4e;
    address devWallet = 0x8D25924876A9b37a59B7934091Ab781B34b4CF6c;
    ...
    constructor () public {
        ...
        _isExcludedFromFee[mainWallet] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), mainWallet, _tTotal);
    }
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        uint256 tBurn = tFee.mul(2).div(7);
    ...
    function burn(uint256 percent) public onlyOwner() {
        uint256 currentRate =  _getRate();
        uint256 tBurn = _tTotal.mul(percent).div(100);

        _tTotal = _tTotal.sub(tBurn);
        _tOwned[_msgSender()] = _tOwned[_msgSender()].sub(tBurn);
        _rOwned[_msgSender()] = _rOwned[_msgSender()].sub(tBurn.mul(currentRate));
    }
}